						...
						while ($row = $res->fetch_object()) { ?>
							...
							<td>
								<ul class="menu menu-horizontal">
									<li>
										<a href="edit-plaats.php?id=<?php echo $row->id; ?>" title="Edit" class="tooltip" data-tip="Edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-3 w-3"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
									...
									<?php if (!strlen($_SESSION["admin_id"]) == 0) { ?>
										<li>
											<a href="delete-plaats.php?id=<?php echo $row->id; ?>" title="Delete" class="tooltip" data-tip="Delete">
