...
<script>
    pdfMake.vfs = {
        'Roboto-Regular.ttf': '<?php echo base64_encode(file_get_contents('assets/fonts/Roboto-Regular.ttf')); ?>',
        'Roboto-Medium.ttf': '<?php echo base64_encode(file_get_contents('assets/fonts/Roboto-Medium.ttf')); ?>',
        'Roboto-Italic.ttf': '<?php echo base64_encode(file_get_contents('assets/fonts/Roboto-Italic.ttf')); ?>',
        'Roboto-MediumItalic.ttf': '<?php echo base64_encode(file_get_contents('assets/fonts/Roboto-MediumItalic.ttf')); ?>'
    };
    ...
    pdfMake.createPdf(docDefinition).download('boeking.pdf');
</script>
